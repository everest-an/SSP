...
const menuItems = [
  ...
  { icon: User, label: "Face Registration", path: "/face-registration" },
];

const adminMenuItems = [
  { icon: Shield, label: "Admin Panel", path: "/admin", isHeader: true },
  { icon: Users, label: "User Management", path: "/admin/users" },
  { icon: CreditCard, label: "Transaction Monitor", path: "/admin/transactions" },
            ...
            <SidebarMenu className="px-2 py-1">
              ...
              {user?.role === "admin" && (
                <>
                  ...
                  {adminMenuItems.filter(item => !item.isHeader).map(item => {
                    const isActive = location === item.path;
                    return (
                      <SidebarMenuItem key={item.path}>
                        <SidebarMenuButton
